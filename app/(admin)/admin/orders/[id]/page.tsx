...
import { AdminOrderStatusForm } from "@/components/admin/OrderStatusForm";
  ...
  return (
    <div className="p-6 lg:p-8">
      ...
      <div className="flex flex-wrap items-start justify-between gap-4 mb-6">
        ...
        <span
          className={`font-sans text-sm px-3 py-1 rounded-full ${ORDER_STATUS_COLORS[order.status]}`}
        >
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="bg-white border border-sand-200 rounded-xl p-6">
              ...
              {order.items.map(
                (
                  ...
                  <div key={i} className="flex gap-4">
                    ...
                    <p className="font-sans text-sm font-medium text-charcoal shrink-0">
            ...
            <div className="border-t border-sand-100 mt-4 pt-4 space-y-2 font-sans text-sm">
              ...
              <div className="flex justify-between font-semibold text-charcoal text-base pt-1 border-t border-sand-100">
                <span>Total</span>
