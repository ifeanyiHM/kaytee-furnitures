    ...
    <div className="min-h-screen bg-sand-50 flex items-center justify-center px-4 py-16">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="font-display text-3xl text-charcoal mb-2">Create your account</h1>
          <p className="font-sans text-charcoal-muted text-sm">Join thousands of design-conscious homeowners</p>
        </div>
